gsap.from(".photo", {x:-200, opacity:0, duration:3, delay:1})
gsap.from(".name", {y:-100, ease:"elactic", opacity:0, duration:2, delay:2})
gsap.from(".first", {x:-300, opacity:-1, duration:3, delay:3})
gsap.from(".second", {x:-300, opacity:-1, duration:4, delay:5})
gsap.from(".care", {y:40, opacity:-2, ease:"bonuce", duration:3, delay:7})
